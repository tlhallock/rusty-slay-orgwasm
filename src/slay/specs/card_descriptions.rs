...
// use super::{cards::card_type::SlayCardSpec, hero::HeroAbilityType, monster::Monster, items::{AnotherItemType, Item}, magic::MagicSpell, modifier::ModifierKinds};
...
//         },
//         SlayCardSpec::PartyLeader(leader_type) =>
//         match leader_type {
...
//         }
//         SlayCardSpec::MonsterCard(monster) =>
//           match monster {
...
//             HeroType::Sorcerer => "If the equipped Hero card would be sacrificed or destroyed, move Decoy Doll to the discard pile instead.",
//                 HeroType::Beserker => todo!(),
//                 HeroType::Necromancer => todo!(),
//                 HeroType::Druid => todo!(),
//                 HeroType::Warrior => todo!(),
