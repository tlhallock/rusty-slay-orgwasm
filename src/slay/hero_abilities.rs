...
use super::{tasks::{PlayerTask, TaskParamName}, abilities::{params::{ChoosePlayerParameterTask, ClearParamsTask, ChooseCardFromPlayerParameterTask}, pull::PullFromTask, heros::{VictimDraws, self}, immediate::OfferPlayImmediately, steal::{self, StealTask}, destroy::{DestroyCardTask, DestroyModifiersDestination}}, specification::CardType};
...
impl HeroAbilityType {
  pub fn create_tasks(&self) -> Vec<Box<dyn PlayerTask>> {
    match self {
        ...
        HeroAbilityType::SmoothMimimeow => vec![
